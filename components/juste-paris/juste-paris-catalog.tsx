...
export function JusteParisCatalog() {
  return (
    <>
      {/* Hero */}
      <section className="relative bg-background dark:bg-background overflow-hidden py-20 md:py-32">
        {/* Décor cercle vert */}
        <div className="absolute -top-32 -right-32 w-[500px] h-[500px] rounded-full bg-green-500 opacity-5 dark:opacity-10 pointer-events-none" />
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              {/* Badge partenaire */}
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium mb-8 bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-300">
              ...
              {/* Logo typographique */}
              <div className="mb-6">
                <h1 className="text-6xl sm:text-7xl md:text-8xl font-serif font-bold tracking-tight leading-none text-green-950 dark:text-green-50">
                  juste
                </h1>
                <p className="text-2xl sm:text-3xl font-light tracking-[0.3em] uppercase text-green-700 dark:text-green-400">
                  paris
                </p>
              </div>

              <p className="text-xl sm:text-2xl text-foreground-secondary font-light leading-relaxed mb-4 max-w-xl">
              ...
              {/* Badge disponible sur place */}
              <div className="inline-flex items-center gap-3 mt-8 px-5 py-3 rounded-2xl border bg-green-50 dark:bg-green-900/30 border-green-200 dark:border-green-700 text-green-900 dark:text-green-200">
            ...
            >
              <div className="w-72 h-72 sm:w-96 sm:h-96 rounded-full flex items-center justify-center bg-gradient-to-br from-green-100 to-green-200 dark:from-green-900/50 dark:to-green-800/50">
                <div className="text-center">
                  ...
                  <p className="text-xs mt-3 tracking-wide text-green-700 dark:text-green-400 font-medium">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {values.map((v, i) => (
              <motion.div
                ...
                className="flex flex-col items-center text-center p-6 rounded-2xl bg-white dark:bg-green-900/20 border border-green-100 dark:border-green-800/50"
              >
                <div className="w-12 h-12 rounded-full flex items-center justify-center mb-3 bg-green-100 dark:bg-green-900/50">
                  <v.icon className="h-6 w-6 text-green-700 dark:text-green-400" />
                </div>
                <p className="font-semibold text-sm mb-1 text-green-950 dark:text-green-100">
                  {v.label}
                </p>
      ...
      {/* Catalogue produits */}
      <section className="py-20 md:py-28 bg-background dark:bg-background">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div
          ...
          >
            <p className="text-sm font-medium tracking-widest uppercase mb-3 text-green-700 dark:text-green-400">
              La gamme
            </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {products.map((product, index) => (
              <motion.div
                ...
                className="rounded-3xl overflow-hidden flex flex-col bg-white dark:bg-green-950/30 border border-green-100 dark:border-green-800/40 shadow-sm hover:shadow-md transition-shadow duration-300"
              >
                {/* Image produit */}
                <div className="relative h-56 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/40 dark:to-green-800/30 flex items-center justify-center overflow-hidden">
                  <Image
                    src={product.image}
                    alt={product.name}
                    width={200}
                ...
                <div className="p-6 flex-1 flex flex-col">
                  <h3 className="text-xl font-serif font-bold mb-1 text-green-950 dark:text-green-50">
                    {product.name}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-2 mb-5">
                    {product.badges.map((badge) => (
                      <span
                        key={badge}
                        className="text-xs font-medium px-3 py-1 rounded-full bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-300"
                      >
                        {badge}
                      </span>
                    ))}
                  ...
                  {/* Prix + dispo */}
                  <div className="mt-auto pt-5 border-t border-green-100 dark:border-green-800/40">
                    <div className="flex flex-wrap gap-5 mb-4">
                      {product.variants.map((v) => (
                        <div key={v.label}>
                          ...
                          <p className="text-xs text-foreground-secondary">{v.label}</p>
                        </div>
                      ))}
                    </div>
                    <div className="inline-flex items-center gap-2 text-xs font-medium px-3 py-2 rounded-xl bg-green-50 dark:bg-green-900/30 text-green-800 dark:text-green-300 border border-green-200 dark:border-green-800/50">
      ...
      {/* CTA final */}
      <section className="py-20 md:py-28 bg-gradient-to-br from-green-900 to-green-700 dark:from-green-950 dark:to-green-900">
        <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-3 px-6 py-4 rounded-2xl bg-white/10 dark:bg-white/5 border border-white/20 text-white">
