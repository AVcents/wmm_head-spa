...
interface PrestationsContentProps {
  services: Service[]
  scheduleHours?: { day: string; hours: string }[]
}

export function PrestationsContent({ services }: PrestationsContentProps) {
  ...
  }, [services, selectedCategory, selectedDuration, selectedPrice])
